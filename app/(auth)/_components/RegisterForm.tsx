        ...
        <div className="p-12 lg:p-16">
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmitForm)}>
            ...
            <div>
              ...
              <input id="phone" type="tel" {...register("phone")} onBlur={() => trigger("phone")} className={`w-full h-12 px-4 text-sm rounded-xl border-2 bg-gray-50/50 text-gray-900 placeholder:text-gray-400 focus:outline-none focus:bg-white transition-all ${errors.phone && (touchedFields.phone || isSubmitted) ? 'border-red-400 focus:ring-2 focus:ring-red-500' : 'border-gray-600 focus:ring-2'}`} placeholder="9800000000" />
